...
import { updateVideo } from "../../features/videoFeatures/videoThunks";

export default function UpdateVideo() {
  const [videoId, setVideoId] = useState("6986e2489f8c3cb997eaa7f9");
  ...
  const handelUpdateVideo = async (e) => {
