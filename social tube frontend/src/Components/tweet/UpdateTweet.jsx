...
import { updateTweet } from "../../features/tweetFeatures/tweetThunks";

export default function UpdateTweet() {
    const [content, setContent] = useState("");
    const [tweetId , setTweetId] = useState("6964c4f91af0a9bd4e1f03ed");
    ...
    const handelTweetSubmit = async (e) => {
        ...
        dispatch(updateTweet({tweetId , formData}));
